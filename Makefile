...
LIBDIR_DEBUG = $(LIBDIR)
LIB_DEBUG = $(LIB)
LDFLAGS_DEBUG = $(LDFLAGS) -pg -lJudy
...
OBJ_DEBUG = $(OBJDIR_DEBUG)/src/fasta.o $(OBJDIR_DEBUG)/src/CC.o $(OBJDIR_DEBUG)/src/UC.o $(OBJDIR_DEBUG)/src/UC_annotation.o $(OBJDIR_DEBUG)/src/annotation.o $(OBJDIR_DEBUG)/src/annotation_special_nodes.o $(OBJDIR_DEBUG)/src/blake2b.o $(OBJDIR_DEBUG)/src/branchingNode.o $(OBJDIR_DEBUG)/src/deleteColorsNode.o $(OBJDIR_DEBUG)/src/extract_kmers.o $(OBJDIR_DEBUG)/src/getRSS.o $(OBJDIR_DEBUG)/src/insertNode.o $(OBJDIR_DEBUG)/src/list.o $(OBJDIR_DEBUG)/src/main.o $(OBJDIR_DEBUG)/src/marking.o $(OBJDIR_DEBUG)/src/presenceNode.o $(OBJDIR_DEBUG)/src/printMemory.o $(OBJDIR_DEBUG)/src/quicksort.o $(OBJDIR_DEBUG)/src/replaceAnnotation.o $(OBJDIR_DEBUG)/src/retrieveAnnotation.o $(OBJDIR_DEBUG)/src/write_to_disk.o $(OBJDIR_DEBUG)/src/xxhash.o $(OBJDIR_DEBUG)/src/interface.o $(OBJDIR_DEBUG)/src/file_io.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/src/fasta.o $(OBJDIR_RELEASE)/src/CC.o $(OBJDIR_RELEASE)/src/UC.o $(OBJDIR_RELEASE)/src/UC_annotation.o $(OBJDIR_RELEASE)/src/annotation.o $(OBJDIR_RELEASE)/src/annotation_special_nodes.o $(OBJDIR_RELEASE)/src/blake2b.o $(OBJDIR_RELEASE)/src/branchingNode.o $(OBJDIR_RELEASE)/src/deleteColorsNode.o $(OBJDIR_RELEASE)/src/extract_kmers.o $(OBJDIR_RELEASE)/src/getRSS.o $(OBJDIR_RELEASE)/src/insertNode.o $(OBJDIR_RELEASE)/src/list.o $(OBJDIR_RELEASE)/src/main.o $(OBJDIR_RELEASE)/src/marking.o $(OBJDIR_RELEASE)/src/presenceNode.o $(OBJDIR_RELEASE)/src/printMemory.o $(OBJDIR_RELEASE)/src/quicksort.o $(OBJDIR_RELEASE)/src/replaceAnnotation.o $(OBJDIR_RELEASE)/src/retrieveAnnotation.o $(OBJDIR_RELEASE)/src/write_to_disk.o $(OBJDIR_RELEASE)/src/xxhash.o $(OBJDIR_RELEASE)/src/interface.o $(OBJDIR_RELEASE)/src/file_io.o
...
$(OBJDIR_DEBUG)/src/blake2b.o: src/blake2b.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/blake2b.c -o $(OBJDIR_DEBUG)/src/blake2b.o
...
$(OBJDIR_DEBUG)/src/extract_kmers.o: src/extract_kmers.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/extract_kmers.c -o $(OBJDIR_DEBUG)/src/extract_kmers.o
...
$(OBJDIR_DEBUG)/src/xxhash.o: src/xxhash.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/xxhash.c -o $(OBJDIR_DEBUG)/src/xxhash.o

$(OBJDIR_DEBUG)/src/interface.o: src/interface.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/interface.c -o $(OBJDIR_DEBUG)/src/interface.o

$(OBJDIR_DEBUG)/src/file_io.o: src/file_io.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/file_io.c -o $(OBJDIR_DEBUG)/src/file_io.o
...
$(OBJDIR_RELEASE)/src/blake2b.o: src/blake2b.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/blake2b.c -o $(OBJDIR_RELEASE)/src/blake2b.o
...
$(OBJDIR_RELEASE)/src/extract_kmers.o: src/extract_kmers.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/extract_kmers.c -o $(OBJDIR_RELEASE)/src/extract_kmers.o
...
$(OBJDIR_RELEASE)/src/xxhash.o: src/xxhash.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/xxhash.c -o $(OBJDIR_RELEASE)/src/xxhash.o

$(OBJDIR_RELEASE)/src/interface.o: src/interface.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/interface.c -o $(OBJDIR_RELEASE)/src/interface.o

$(OBJDIR_RELEASE)/src/file_io.o: src/file_io.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/file_io.c -o $(OBJDIR_RELEASE)/src/file_io.o
