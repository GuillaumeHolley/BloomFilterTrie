...
LD=gcc
LDFLAGS=
LIBS=-ljemalloc -lJudy -lgomp  -lm
CFLAGS=-O3 -Wall -std=c99 -Wno-unknown-pragmas -msse4.1 -mpopcnt
...
install:
	@install -d -m 755 $(DESTDIR)$(INCLUDEDIR)/ $(DESTDIR)$(INCLUDEDIR)/bft $(DESTDIR)$(SRCDIR)/bft
