...
OBJ_RELEASE = $(OBJDIR_RELEASE)/src/getRSS.o $(OBJDIR_RELEASE)/src/CC.o $(OBJDIR_RELEASE)/src/UC.o $(OBJDIR_RELEASE)/src/UC_annotation.o $(OBJDIR_RELEASE)/src/annotation.o $(OBJDIR_RELEASE)/src/annotation_special_nodes.o $(OBJDIR_RELEASE)/src/branchingNode.o $(OBJDIR_RELEASE)/src/deleteColorsNode.o $(OBJDIR_RELEASE)/src/extract_kmers.o $(OBJDIR_RELEASE)/src/fasta.o $(OBJDIR_RELEASE)/src/insertNode.o $(OBJDIR_RELEASE)/src/list.o $(OBJDIR_RELEASE)/src/main.o $(OBJDIR_RELEASE)/src/marking.o $(OBJDIR_RELEASE)/src/presenceNode.o $(OBJDIR_RELEASE)/src/printMemory.o $(OBJDIR_RELEASE)/src/quicksort.o $(OBJDIR_RELEASE)/src/replaceAnnotation.o $(OBJDIR_RELEASE)/src/retrieveAnnotation.o $(OBJDIR_RELEASE)/src/write_to_disk.o $(OBJDIR_RELEASE)/src/xxhash.o
